public class MoveBackwardCard extends ChanceCard implements CommunityChestCard {
	...
	public MoveBackwardCard(int cardNo) {
		super(cardNo);
	}
	...
	public void cardOperations(Player player, Board board) {
		...
		player.whereWillBeTokenLocated(board, "backward");
	}
